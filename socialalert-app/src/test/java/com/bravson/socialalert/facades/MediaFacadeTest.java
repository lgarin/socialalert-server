...
public class MediaFacadeTest extends DataServiceTest {
	...
	public void claimValidPicture() throws IOException {
		...
		assertEquals(Integer.valueOf(2448), info.getWidth());
		assertEquals(Integer.valueOf(3264), info.getHeight());
		assertEquals(new DateTime(2013, 4, 14, 16, 28, 26), info.getTimestamp());
		assertEquals("Apple", info.getCameraMaker());
		assertEquals("iPhone 5", info.getCameraModel());
		assertEquals(46.68666666666667, info.getLatitude(), 0.0);
		assertEquals(7.858833333333333, info.getLongitude(), 0.0);
	...
	public void updateExistingPicture() throws IOException {
		...
		MediaInfo info = facade.updateMediaInfo(pictureUri, "New title", "A description", null, "Sony", "RX100II", null, Collections.singletonList(MediaCategory.NEWS), Collections.singletonList("New tag"));
		assertNotNull(info);
	...
	@Test
	public void viewValidPictureURI() throws IOException {
		userFacade.login("lucien@test.com", "123");
		MediaInfo info = facade.viewMediaDetail(URI.create("20130712/7e9a5a5bd5e64171c176ac6c7b32d685.jpg"));
		assertNotNull(info);
		assertEquals(2, info.getHitCount());
	}
	
	@Test
	public void viewValidVideoURI() throws IOException {
		userFacade.login("lucien@test.com", "123");
		MediaInfo info = facade.viewMediaDetail(URI.create("20150429/7e9a5a5bd5e64171c176ac6c7b32d685.MOV"));
		assertNotNull(info);
		assertEquals(11, info.getHitCount());
	}
	
	@Test(expected=DataMissingException.class)
	public void viewInvalidURI() throws IOException {
		userFacade.login("lucien@test.com", "123");
		facade.viewMediaDetail(URI.create("xxx.jpg"));
	}
	...
	public void dislikeLikedPicture() throws IOException {
		userFacade.login("lucien@test.com", "123");
		URI pictureUri = URI.create("20130712/7e9a5a5bd5e64171c176ac6c7b32d685.jpg");
		MediaInfo info = facade.setMediaApproval(pictureUri, ApprovalModifier.DISLIKE);
		assertNotNull(info);
		assertEquals(pictureUri, info.getMediaUri());
		assertEquals(0, info.getLikeCount());
	...
	public void likeLikedPicture() throws IOException {
		userFacade.login("lucien@test.com", "123");
		URI pictureUri = URI.create("20130712/7e9a5a5bd5e64171c176ac6c7b32d685.jpg");
		MediaInfo info = facade.setMediaApproval(pictureUri, ApprovalModifier.LIKE);
		assertNotNull(info);
		assertEquals(pictureUri, info.getMediaUri());
	...
	public void likeUnknownPicture() throws IOException {
		...
		facade.setMediaApproval(pictureUri, ApprovalModifier.DISLIKE);
	}
	...
	public void listPicturesByExistingProfileId() throws IOException {
		userFacade.login("lucien@test.com", "123");
		QueryResult<MediaInfo> result = facade.listMediaByProfile(MediaType.PICTURE, UUID.fromString("a95472c0-e0e6-11e2-a28f-0800200c9a77"), 0, 10);
		assertNotNull(result);
		assertEquals(0, result.getPageNumber());
		assertEquals(1, result.getPageCount());
		assertNotNull(result.getContent());
	...
	@Test
	public void listVideosByExistingProfileId() throws IOException {
		userFacade.login("lucien@test.com", "123");
		QueryResult<MediaInfo> result = facade.listMediaByProfile(MediaType.VIDEO, UUID.fromString("e7d166ae-9b3f-4405-be0d-fa1567728593"), 0, 10);
		assertNotNull(result);
		assertEquals(0, result.getPageNumber());
		assertEquals(1, result.getPageCount());
		assertNotNull(result.getContent());
	...
	public void listPicturesByNonExistingProfileId() throws IOException {
		userFacade.login("lucien@test.com", "123");
		QueryResult<MediaInfo> result = facade.listMediaByProfile(MediaType.PICTURE, UUID.fromString("ddd166ae-9b3f-4405-be0d-fa1567728593"), 0, 10);
		assertNotNull(result);
		assertEquals(0, result.getPageNumber());
	...
	@Test
	public void findPictureSuggestion() throws IOException {
		userFacade.login("lucien@test.com", "123");
		List<String> suggestions = facade.findKeywordSuggestions(MediaType.PICTURE, "para");
		assertEquals(Collections.singletonList("paragliding"), suggestions);
	}
	
	@Test
	public void findVideoSuggestion() throws IOException {
		userFacade.login("lucien@test.com", "123");
		List<String> suggestions = facade.findKeywordSuggestions(MediaType.VIDEO, "AQUA");
	...
	public void mapPictureMatchCountWithKeyword() throws IOException {
		userFacade.login("lucien@test.com", "123");
		List<GeoStatistic> result = facade.mapMediaMatchCount(MediaType.PICTURE, 46.95, 7.5, 100.0, "paragliding", 3650 * DateUtils.MILLIS_PER_DAY, null);
		assertNotNull(result);
		assertEquals(1, result.size());
	...
	public void mapPictureMatchCountWithoutKeyword() throws IOException {
		userFacade.login("lucien@test.com", "123");
		List<GeoStatistic> result = facade.mapMediaMatchCount(MediaType.PICTURE, 46.95, 7.5, 100.0, null, 3650 * DateUtils.MILLIS_PER_DAY, null);
		assertNotNull(result);
		assertEquals(1, result.size());
		GeoStatistic stat = result.iterator().next();
		assertEquals(1, stat.getCount());
	...
	public void repostExistingPictureTwice() throws IOException {
		userFacade.login("lucien@test.com", "123");
		ActivityInfo info = facade.repostMedia(URI.create("20130716/f317f3c7918c83ff6ec24aabb6c017fd.jpg"));
		assertNotNull(info);
		assertEquals(ActivityType.REPOST_PICTURE, info.getActivityType());
		assertEquals("sg33g5", info.getCreator());
		assertNull(info.getMessage());
		ActivityInfo info2 = facade.repostMedia(URI.create("20130716/f317f3c7918c83ff6ec24aabb6c017fd.jpg"));
		assertNull(info2);
	}
	...
	public void repostNonExistingPicture() throws IOException {
		userFacade.login("lucien@test.com", "123");
		facade.repostMedia(URI.create("20130712/99.jpg"));
	}
	
	@Test
	public void searchPictures() throws IOException {
		userFacade.login("lucien@test.com", "123");
		QueryResult<MediaInfo> result = facade.searchMedia(MediaType.PICTURE, null, null, null, "sport", 3650 * DateUtils.MILLIS_PER_DAY, 0, 10);
		assertNotNull(result);
		assertEquals(0, result.getPageNumber());
		assertEquals(1, result.getPageCount());
		assertNotNull(result.getContent());
	...
	public void searchPicturesInCategory() throws IOException {
		userFacade.login("lucien@test.com", "123");
		QueryResult<MediaInfo> result = facade.searchMediaInCategory(MediaType.PICTURE, null, null, null, "sport", 3650 * DateUtils.MILLIS_PER_DAY, "PLACES", 0, 10);
		assertNotNull(result);
		assertEquals(0, result.getPageNumber());
		assertEquals(1, result.getPageCount());
		assertNotNull(result.getContent());
	...
	public void searchTopPicturesByCategories() throws IOException {
		userFacade.login("lucien@test.com", "123");
		Map<String, List<MediaInfo>> result = facade.searchTopMediaByCategories(MediaType.PICTURE, null, null, null, null, 3650 * DateUtils.MILLIS_PER_DAY, Arrays.asList("ART", "PLACES"), 10);
		assertNotNull(result);
	...
	@Test
	public void searchTopMediaByCategories() throws IOException {
		userFacade.login("lucien@test.com", "123");
		Map<String, List<MediaInfo>> result = facade.searchTopMediaByCategories(null, null, null, null, null, 3650 * DateUtils.MILLIS_PER_DAY, Arrays.asList("ART", "PLACES"), 10);
		assertNotNull(result);
		assertEquals(3, result.get("PLACES").size());
		assertEquals(0, result.get("ART").size());
	}
}
